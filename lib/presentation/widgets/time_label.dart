...
class TimeLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChartBloc, ChartState>(builder: (c, state) {
      if (state is ChartFocusSuccess) {
        ...
        final period =
            isHome ? portfolioBloc.portfolio.period : assetBloc.period;
        return buildTimeLabel(
            context, period, state.chart.xOffSet, state.chart.time);
      }
